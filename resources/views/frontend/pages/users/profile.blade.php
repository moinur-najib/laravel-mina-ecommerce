...
<div class='container'>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('user.profile.update') }}">
            ...
            <div class="form-group row">
                <label for="street_adress" class="col-md-4 col-form-label text-md-right">Street adress</label>

                <div class="col-md-6">
                    <input id="street_adress" type="text" class="form-control @error('street_adress') is-invalid @enderror" name="street_adress" value="{{ $user->street_adress }}" required autocomplete="street_adress" autofocus>
            ...
            <div class="form-group row">
                <label for="shipping_adress" class="col-md-4 col-form-label text-md-right">Shipping adress (optional)</label>

                <div class="col-md-6">
                    <textarea id="shipping_adress" type="text" class="form-control @error('shipping_adress') is-invalid @enderror" name="shipping_adress" rows="4" autocomplete="shipping_adress" autofocus>
                    {{ $user->shipping_adress }}
                    </textarea>
